...
css_patch = """
        /* --- Accordion Sidebar CSS v8 (Fix Upgrade Card Visibility & Text Wrap) --- */
        ...
        /* Upgrade Card Styling (Green & Hover prominent, Override Old CSS) */
        .upgrade-card { 
            ...
            transform: none !important; /* Remove old translateY */
        }
        .upgrade-card:hover { 
        ...
        .upgrade-icon { font-size: 20px; color: var(--primary-green); width: 24px; text-align: center; flex-shrink: 0; }
        ...
        .upgrade-content h4 { font-size: 13px; color: var(--primary-green); margin: 0 0 2px 0; font-weight: 600; white-space: nowrap; }
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v7' in content:
    ...
    print(f"Patched {filename} with v8 CSS")
