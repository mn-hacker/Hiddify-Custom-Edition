...
css_patch = """
        /* --- Accordion Sidebar CSS v7 (Circular Pill & Green Upgrade) --- */
        ...
        /* Upgrade Card Styling (Green & Hover prominent) */
        .upgrade-card { 
        ...
        .upgrade-icon { font-size: 20px; color: var(--primary-green); width: 24px; text-align: center; }
        ...
        .upgrade-content h4 { font-size: 13px; color: var(--primary-green); margin: 0 0 4px 0; font-weight: 600; }
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v6' in content:
    ...
    print(f"Patched {filename} with v7 CSS")
