...
css_patch = """
        /* --- Accordion Sidebar CSS v14 (Alive Animated Logo & Centering) --- */
        ...
        /* Logo Centering */
        .logo { display: flex; align-items: center; justify-content: center; margin-bottom: 40px; height: 50px; flex-shrink: 0; padding: 0; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); cursor: pointer; }
        ...
        /* Logo Text */
        .logo-text { max-width: 0; opacity: 0; overflow: hidden; white-space: nowrap; margin-left: 0; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.2s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); font-size: 19px; font-weight: 700; color: #fff; letter-spacing: 0.5px; }
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v13' in content:
    ...
    print(f"Patched {filename} with v14 CSS")
