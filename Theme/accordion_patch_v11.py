...
css_patch = """
        /* --- Accordion Sidebar CSS v11 (Fix Padding Clipping & Icon Alignment) --- */
        /* Changed padding to 20px 0 to unlock full 86px inner width for precise math */
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v10' in content:
    ...
    print(f"Patched {filename} with v11 CSS")
