...
css_patch = """
        /* --- Accordion Sidebar CSS v15 (Perfect Logo Alignment & Closer Text) --- */
        ...
        .sidebar:hover .logo-text { max-width: 200px; opacity: 1; margin-left: 8px; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s 0.1s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); }
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v14' in content:
    ...
    print(f"Patched {filename} with v15 CSS")
