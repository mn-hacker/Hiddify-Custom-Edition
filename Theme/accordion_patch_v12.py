...
css_patch = """
        /* --- Accordion Sidebar CSS v12 (Upgrade Card Circular Morph) --- */
        ...
        /* Upgrade Card Styling - Circular Morph */
        .upgrade-card { 
        ...
        .sidebar:not(:hover) .upgrade-card {
            border-radius: 50% !important; /* Perfect circle in collapsed state */
        ...
        .sidebar:not(:hover) .upgrade-card:hover {
            transform: scale(1.1) !important; /* Bump effect instead of lift for circle */
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v11' in content:
    ...
    print(f"Patched {filename} with v12 CSS")
