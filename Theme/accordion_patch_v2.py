...
css_patch = """
        /* --- Accordion Sidebar CSS v2 (Click) --- */
        ...
        .nav-item-header { display: flex; justify-content: space-between; align-items: center; padding: 12px 20px; border-radius: 8px; color: var(--text-muted); cursor: pointer; transition: all 0.3s; margin: 0 10px; }
        ...
        .nav-accordion { max-height: 0; overflow: hidden; transition: max-height 0.4s cubic-bezier(0.25, 0.8, 0.25, 1); display: flex; flex-direction: column; gap: 4px; padding: 0; }
        .nav-item-group.open .nav-accordion { max-height: 400px; margin-top: 4px; margin-bottom: 4px; }
        
        .nav-item { display: flex; align-items: center; gap: 16px; padding: 10px 20px; border-radius: 8px; color: var(--text-muted); text-decoration: none; font-size: 13px; font-weight: 500; transition: all 0.3s; white-space: nowrap; margin: 0 10px; }
        .sidebar:hover .nav-accordion .nav-item { padding-left: 50px; } 
...
sidebar_html = """<div class="logo">
    ...
    <div class="nav-menu">
        <div class="nav-item-group {overview_group_class}">
            <div class="nav-item-header {overview_active}" onclick="this.parentElement.classList.toggle('open')">
        ...
        <div class="nav-item-group {access_group_class}">
            <div class="nav-item-header {access_active}" onclick="this.parentElement.classList.toggle('open')">
                <div class="nav-header-left">
        ...
        <div class="nav-item-group {network_group_class}">
            <div class="nav-item-header {network_active}" onclick="this.parentElement.classList.toggle('open')">
                <div class="nav-header-left">
        ...
        <div class="nav-item-group {system_group_class}">
            <div class="nav-item-header {system_active}" onclick="this.parentElement.classList.toggle('open')">
                <div class="nav-header-left">
...
for filename in files:
    ...
    # Insert CSS
    if '/* --- Accordion Sidebar CSS v2 (Click) --- */' not in content:
