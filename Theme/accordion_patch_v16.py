...
css_patch = """
        /* --- Accordion Sidebar CSS v16 (Fix Logo Text Clipping) --- */
        ...
        /* Logo Text - Reduced font size to fit in 250px container */
        .logo-text { max-width: 0; opacity: 0; overflow: hidden; white-space: nowrap; margin-left: 0; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.2s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); font-size: 16px; font-weight: 700; color: #fff; }
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v15' in content:
    ...
    print(f"Patched {filename} with v16 CSS")
