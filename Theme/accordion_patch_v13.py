...
css_patch = """
        /* --- Accordion Sidebar CSS v13 (Naked Lightning Icon) --- */
        ...
        /* Upgrade Card Styling - Naked Icon */
        .upgrade-card { 
        ...
        /* Remove background and border when collapsed */
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v12' in content:
    ...
    print(f"Patched {filename} with v13 CSS")
