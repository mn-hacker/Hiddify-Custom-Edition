...
css_patch = """
        /* --- Accordion Sidebar CSS v10 (Butter-Smooth 60fps Animations) --- */
        .sidebar { width: 86px !important; overflow-x: hidden !important; padding-top: 20px !important; transition: width 0.4s cubic-bezier(0.4, 0, 0.2, 1) !important; border-right: 1px solid var(--border-color); display: flex; flex-direction: column; }
        .sidebar:hover { width: 250px !important; } 
        
        .logo { display: flex; align-items: center; justify-content: flex-start; margin-bottom: 40px; height: 50px; flex-shrink: 0; padding-left: 31px; transition: padding 0.4s cubic-bezier(0.4, 0, 0.2, 1); }
        .sidebar:hover .logo { padding-left: 24px; }
        .logo i { font-size: 24px; color: var(--primary-purple); text-align: center; width: 24px; flex-shrink: 0; }
        .logo-text { max-width: 0; opacity: 0; overflow: hidden; white-space: nowrap; margin-left: 0; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.2s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); font-size: 18px; font-weight: 600; }
        .sidebar:hover .logo-text { max-width: 200px; opacity: 1; margin-left: 12px; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s 0.1s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); }
        ...
        /* Eliminate justify-content snaps by using padding-left to center exactly */
        ...
        /* Smooth Circular Pill using ::before to avoid width snaps */
        ...
        .nav-text { max-width: 0; opacity: 0; overflow: hidden; white-space: nowrap; margin-left: 0; transition: max-width 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.2s, margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1); display: inline-block; vertical-align: middle; }
        ...
        /* Tighter max-height prevents jerky speed differences */
        ...
        /* Upgrade Card Styling - Butter Smooth */
        .upgrade-card { 
            ...
            padding: 12px 14px !important; /* 54px total width -> perfectly centers 24px icon */
...
for filename in files:
    ...
    if '/* --- Accordion Sidebar CSS v9' in content:
    ...
    print(f"Patched {filename} with v10 CSS")
