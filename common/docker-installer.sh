...
if [[ "$TAG" == "develop" || "$TAG" == "dev" ]]; then
    ...
    git clone https://github.com/mn-hacker/Hiddify-Custom-Edition.git
    cd Hiddify-Manager
  ...
  cd hiddify-manager
  wget https://raw.githubusercontent.com/mn-hacker/Hiddify-Custom-Edition/refs/heads/main/docker-compose.yml
fi
